...
public class GUI_Cipher {
	...
	private void initialize() {
		...
		ImageIcon img = new ImageIcon(this.getClass().getResource("/starryN.jpg")); //Saves the image to 'img'
		lblNewLabel_1.setIcon(img); //Sets the image to 'img'
